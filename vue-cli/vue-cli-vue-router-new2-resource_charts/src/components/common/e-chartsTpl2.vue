   ...
   <div class = "chart">
    <span class="btnBox">
        <select v-model="coinSelected" @change="lineFun(5,0)">
            <option  v-for="itime in coinList" :value="itime"><img :src="'/static/img/'+coinSelected+'.png'"/>{{itime}}</option>
        </select>
            ...
            echartsOption:{
                ...
                series: [{
                ...
                } ,
                  {
                    ...
                    showSymbol:true,
                    lineStyle: {
                        normal: {opacity: 0.5,color:'green',width:0.8}
                    }
                }, {
                    name: 'MA10',
                    type: 'line',
                    ...
                    showSymbol: false,
                    lineStyle: {
                       normal: {opacity: 0.5,color:'blue',width:0.8}
                    }
                }, {
                    name: 'MA20',
                    type: 'line',
                    ...
                    showSymbol: false,
                    lineStyle: {
                      normal: {opacity: 0.5,color:'#e3493c',width:0.8}
                    }
                }
                ]
            }
