...
// this needs to be lazy-evaled because vue2.+ may be required before
// vue2.+-server-renderer can set VUE_ENV
var _isServer;
var isServerRendering = function () {
  if (_isServer === undefined) {
    /* istanbul ignore if */
    if (!inBrowser && typeof global !== 'undefined') {
      // detect presence of vue2.+-server-renderer and avoid
...
function mountComponent (
  ...
  if ("development" !== 'production' && config.performance && mark) {
    updateComponent = function () {
      var name = vm._name;
      var id = vm._uid;
      var startTag = "vue2.+-perf-start:" + id;
      var endTag = "vue2.+-perf-end:" + id;
...
function createComponent (
  ...
  var vnode = new VNode(
    ("vue2.+-component-" + (Ctor.cid) + (name ? ("-" + name) : '')),
...
function initMixin (Vue) {
  Vue.prototype._init = function (options) {
    ...
    /* istanbul ignore if */
    if ("development" !== 'production' && config.performance && mark) {
      startTag = "vue2.+-perf-init:" + (vm._uid);
      endTag = "vue2.+-perf-end:" + (vm._uid);
      mark(startTag);
    }
...
function createPatchFunction (backend) {
  ...
  function assertNodeMatch (node, vnode) {
    if (isDef(vnode.tag)) {
      return (
        vnode.tag.indexOf('vue2.+-component') === 0 ||
  ...
  if (config.devtools) {
    if (devtools) {
      ...
      console[console.info ? 'info' : 'log'](
        ...
        'https://github.com/vuejs/vue2.+-devtools'
      );
    }
  }
  if ("development" !== 'production' &&
